...
-- The erroroutput function is called to generate the error output.
-- It receives the error message generated by the errorhandler function
-- and it is responsible to output the desired message.
-- @param f New error output function.
-- @see seterrorhandler
---------------------------------------------------------------------------
...
-- The so called close-functions are called without any argument and its
...
-- The so called open-functions are called without any argument and its
--	results are discarded.
-- @param f Function to be registered.
-- @see addclosefunction
---------------------------------------------------------------------------
